...
def get_token_from_code(code):
    ...
    print("Sending token request to:", f"https://login.{ENVIRONMENT}/oauth/token")  # ✅ Debugging output
    print("Request Headers:", request_headers)  # ✅ Debugging output
    print("Request Body:", request_body)  # ✅ Debugging output
